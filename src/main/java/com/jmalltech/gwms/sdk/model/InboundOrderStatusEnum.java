 ...
 * 入库单状态枚举
 */
@JsonAdapter(InboundOrderStatusEnum.Adapter.class)
public enum InboundOrderStatusEnum {
  ...
  InboundOrderStatusEnum(String value) {
    this.value = value;
  }
  ...
  public static InboundOrderStatusEnum fromValue(String value) {
    for (InboundOrderStatusEnum b : InboundOrderStatusEnum.values()) {
  ...
  public static class Adapter extends TypeAdapter<InboundOrderStatusEnum> {
    @Override
    public void write(final JsonWriter jsonWriter, final InboundOrderStatusEnum enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public InboundOrderStatusEnum read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return InboundOrderStatusEnum.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    InboundOrderStatusEnum.fromValue(value);
  }
}
