 ...
 * 到仓方式枚举
 */
@JsonAdapter(ArrivalMethodEnum.Adapter.class)
public enum ArrivalMethodEnum {
  
  /**
   * 散箱-不超过25KG - 小件散装货物，重量不超过25公斤
   */
  LCL_LT25KG("LCL_LT25KG"),
  
  /**
   * 标准托盘 - 使用标准尺寸托盘运输的货物
   */
  PALLET_STD("PALLET_STD"),
  
  /**
   * 非标准托盘 - 使用非标准尺寸托盘运输的货物
   */
  PALLET_NON_STD("PALLET_NON_STD"),
  ...
  ArrivalMethodEnum(String value) {
    this.value = value;
  }
  ...
  public static ArrivalMethodEnum fromValue(String value) {
    for (ArrivalMethodEnum b : ArrivalMethodEnum.values()) {
  ...
  public static class Adapter extends TypeAdapter<ArrivalMethodEnum> {
    @Override
    public void write(final JsonWriter jsonWriter, final ArrivalMethodEnum enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ArrivalMethodEnum read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ArrivalMethodEnum.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ArrivalMethodEnum.fromValue(value);
  }
}
