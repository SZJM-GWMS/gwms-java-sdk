 ...
 * 计费状态枚举
 */
@JsonAdapter(ChargeStatus.Adapter.class)
public enum ChargeStatus {
  ...
  public static class Adapter extends TypeAdapter<ChargeStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ChargeStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ChargeStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ChargeStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ChargeStatus.fromValue(value);
  }
}
