...
public class ZoneUpdateRequest implements Serializable {
  ...
  public ZoneUpdateRequest params(Map<String, Object> params) {
    this.params = params;
    return this;
  }

  public ZoneUpdateRequest putParamsItem(String key, Object paramsItem) {
    if (this.params == null) {
  ...
  **/
  ...
  public ZoneUpdateRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ZoneUpdateRequest priority(Long priority) {
 ...
 @Min(1L) @Max(999L)
  ...
  public ZoneUpdateRequest zoneType(ZoneTypeEnum zoneType) {
  ...
  **/
  ...
  public ZoneUpdateRequest remark(String remark) {
    this.remark = remark;
    return this;
  }
 ...
 @Size(max=500)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.params, zoneUpdateRequest.params) &&
        Objects.equals(this.name, zoneUpdateRequest.name) &&
        Objects.equals(this.priority, zoneUpdateRequest.priority) &&
        Objects.equals(this.zoneType, zoneUpdateRequest.zoneType) &&
        Objects.equals(this.remark, zoneUpdateRequest.remark);
  }

  @Override
  public int hashCode() {
    return Objects.hash(params, name, priority, zoneType, remark);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to ZoneUpdateRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ZoneUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ZoneUpdateRequest is not found in the empty JSON string", ZoneUpdateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ZoneUpdateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ZoneUpdateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ZoneUpdateRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ZoneUpdateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ZoneUpdateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ZoneUpdateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ZoneUpdateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ZoneUpdateRequest>() {
           @Override
           public void write(JsonWriter out, ZoneUpdateRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ZoneUpdateRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ZoneUpdateRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ZoneUpdateRequest
  * @throws IOException if the JSON string is invalid with respect to ZoneUpdateRequest
  */
  public static ZoneUpdateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ZoneUpdateRequest.class);
  }

 /**
  * Convert an instance of ZoneUpdateRequest to an JSON string
  *
  * @return JSON string
  */
