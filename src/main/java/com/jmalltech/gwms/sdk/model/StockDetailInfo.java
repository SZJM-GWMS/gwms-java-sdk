...
public class StockDetailInfo implements Serializable {
  ...
  public StockDetailInfo status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public StockDetailInfo age(Integer age) {
    this.age = age;
    return this;
  }
  ...
  **/
  ...
  public StockDetailInfo num(Integer num) {
    this.num = num;
    return this;
  }
  ...
  **/
  ...
  public StockDetailInfo gsku(String gsku) {
    this.gsku = gsku;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StockDetailInfo stockDetailInfo = (StockDetailInfo) o;
    return Objects.equals(this.status, stockDetailInfo.status) &&
        Objects.equals(this.age, stockDetailInfo.age) &&
        Objects.equals(this.num, stockDetailInfo.num) &&
        Objects.equals(this.gsku, stockDetailInfo.gsku);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, age, num, gsku);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StockDetailInfo {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to StockDetailInfo
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StockDetailInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StockDetailInfo is not found in the empty JSON string", StockDetailInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StockDetailInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StockDetailInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StockDetailInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StockDetailInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StockDetailInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StockDetailInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<StockDetailInfo>() {
           @Override
           public void write(JsonWriter out, StockDetailInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StockDetailInfo read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of StockDetailInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of StockDetailInfo
  * @throws IOException if the JSON string is invalid with respect to StockDetailInfo
  */
  public static StockDetailInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StockDetailInfo.class);
  }

 /**
  * Convert an instance of StockDetailInfo to an JSON string
  *
  * @return JSON string
  */
