...
public class InboundOrder implements Serializable {
  ...
  public InboundOrder createBy(Long createBy) {
  ...
  **/
  ...
  public InboundOrder createTime(OffsetDateTime createTime) {
  ...
  **/
  ...
  public InboundOrder updateBy(Long updateBy) {
  ...
  **/
  ...
  public InboundOrder updateTime(OffsetDateTime updateTime) {
  ...
  **/
  ...
  public InboundOrder params(Map<String, Object> params) {
    this.params = params;
    return this;
  }

  public InboundOrder putParamsItem(String key, Object paramsItem) {
    if (this.params == null) {
  ...
  **/
  ...
  public InboundOrder inboundNo(String inboundNo) {
 ...
 @Size(max=50)
  ...
  public InboundOrder inboundType(InboundTypeEnum inboundType) {
  ...
  **/
  ...
  public InboundOrder arriveMethod(ArrivalMethodEnum arriveMethod) {
  ...
  **/
  ...
  public InboundOrder asnOrderCode(String asnOrderCode) {
 ...
 @Pattern(regexp="^[A-Za-z0-9-]{1,50}$") @Size(max=50)
  ...
  public InboundOrder ownerCode(String ownerCode) {
 ...
 @Size(max=100)
  ...
  public InboundOrder warehouseCode(String warehouseCode) {
 ...
 @Size(max=100)
  ...
  public InboundOrder status(InboundOrderStatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public InboundOrder transportType(TransportTypeEnum transportType) {
  ...
  **/
  ...
  public InboundOrder expectArriveTime(OffsetDateTime expectArriveTime) {
  ...
  **/
  ...
  public InboundOrder trackingNo(String trackingNo) {
 ...
 @Size(max=100)
  ...
  public InboundOrder carrierCode(String carrierCode) {
 ...
 @Pattern(regexp="^[A-Za-z0-9-]{1,50}$") @Size(max=50)
  ...
  public InboundOrder attachmentUrls(String attachmentUrls) {
 ...
 @Size(max=2048)
  ...
  public InboundOrder totalBoxReceive(Integer totalBoxReceive) {
 ...
 @Min(0)
  ...
  public InboundOrder totalSkuReceive(Integer totalSkuReceive) {
 ...
 @Min(0)
  ...
  public InboundOrder totalBoxAsn(Integer totalBoxAsn) {
 ...
 @Min(0)
  ...
  public InboundOrder totalSkuAsn(Integer totalSkuAsn) {
 ...
 @Min(0)
  ...
  public InboundOrder lastReceiveTime(OffsetDateTime lastReceiveTime) {
  ...
  **/
  ...
  public InboundOrder isMetric(Boolean isMetric) {
  ...
  **/
  ...
  public InboundOrder remark(String remark) {
    this.remark = remark;
    return this;
  }
 ...
 @Size(max=500)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createBy, inboundOrder.createBy) &&
        Objects.equals(this.createTime, inboundOrder.createTime) &&
        Objects.equals(this.updateBy, inboundOrder.updateBy) &&
        Objects.equals(this.updateTime, inboundOrder.updateTime) &&
        Objects.equals(this.params, inboundOrder.params) &&
        Objects.equals(this.inboundNo, inboundOrder.inboundNo) &&
        Objects.equals(this.inboundType, inboundOrder.inboundType) &&
        Objects.equals(this.arriveMethod, inboundOrder.arriveMethod) &&
        Objects.equals(this.asnOrderCode, inboundOrder.asnOrderCode) &&
        Objects.equals(this.ownerCode, inboundOrder.ownerCode) &&
        Objects.equals(this.ownerName, inboundOrder.ownerName) &&
        Objects.equals(this.warehouseCode, inboundOrder.warehouseCode) &&
        Objects.equals(this.warehouseName, inboundOrder.warehouseName) &&
        Objects.equals(this.status, inboundOrder.status) &&
        Objects.equals(this.transportType, inboundOrder.transportType) &&
        Objects.equals(this.expectArriveTime, inboundOrder.expectArriveTime) &&
        Objects.equals(this.trackingNo, inboundOrder.trackingNo) &&
        Objects.equals(this.carrierCode, inboundOrder.carrierCode) &&
        Objects.equals(this.attachmentUrls, inboundOrder.attachmentUrls) &&
        Objects.equals(this.totalBoxReceive, inboundOrder.totalBoxReceive) &&
        Objects.equals(this.totalSkuReceive, inboundOrder.totalSkuReceive) &&
        Objects.equals(this.totalBoxAsn, inboundOrder.totalBoxAsn) &&
        Objects.equals(this.totalSkuAsn, inboundOrder.totalSkuAsn) &&
        Objects.equals(this.lastReceiveTime, inboundOrder.lastReceiveTime) &&
        Objects.equals(this.isMetric, inboundOrder.isMetric) &&
        Objects.equals(this.remark, inboundOrder.remark);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createBy, createTime, updateBy, updateTime, params, inboundNo, inboundType, arriveMethod, asnOrderCode, ownerCode, ownerName, warehouseCode, warehouseName, status, transportType, expectArriveTime, trackingNo, carrierCode, attachmentUrls, totalBoxReceive, totalSkuReceive, totalBoxAsn, totalSkuAsn, lastReceiveTime, isMetric, remark);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InboundOrder.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InboundOrder is not found in the empty JSON string", InboundOrder.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InboundOrder.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InboundOrder` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<InboundOrder>() {
           @Override
