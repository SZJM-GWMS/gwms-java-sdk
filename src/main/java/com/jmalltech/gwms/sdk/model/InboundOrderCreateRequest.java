...
public class InboundOrderCreateRequest implements Serializable {
  ...
  public InboundOrderCreateRequest params(Map<String, Object> params) {
    this.params = params;
    return this;
  }

  public InboundOrderCreateRequest putParamsItem(String key, Object paramsItem) {
    if (this.params == null) {
  ...
  **/
  ...
  public InboundOrderCreateRequest inboundNo(String inboundNo) {
 ...
 @Size(max=50)
  ...
  public InboundOrderCreateRequest inboundType(InboundTypeEnum inboundType) {
  ...
  **/
  ...
  public InboundOrderCreateRequest arriveMethod(ArrivalMethodEnum arriveMethod) {
  ...
  **/
  ...
  public InboundOrderCreateRequest asnOrderCode(String asnOrderCode) {
 ...
 @Pattern(regexp="^[A-Za-z0-9-]{1,50}$") @Size(max=50)
  ...
  public InboundOrderCreateRequest warehouseCode(String warehouseCode) {
 ...
 @Pattern(regexp="^[A-Za-z0-9-]{1,50}$") @Size(max=50)
  ...
  public InboundOrderCreateRequest transportType(TransportTypeEnum transportType) {
  ...
  **/
  ...
  public InboundOrderCreateRequest expectArriveTime(OffsetDateTime expectArriveTime) {
  ...
  **/
  ...
  public InboundOrderCreateRequest trackingNo(String trackingNo) {
 ...
 @Size(max=100)
  ...
  public InboundOrderCreateRequest carrierCode(String carrierCode) {
 ...
 @Pattern(regexp="^[A-Za-z0-9-]{1,50}$") @Size(max=50)
  ...
  public InboundOrderCreateRequest attachmentUrls(String attachmentUrls) {
 ...
 @Size(max=2048)
  ...
  public InboundOrderCreateRequest remark(String remark) {
    this.remark = remark;
    return this;
  }
 ...
 @Size(max=500)
  ...
  public InboundOrderCreateRequest boxes(List<@Valid InboundOrderBoxCreateRequest> boxes) {
    this.boxes = boxes;
    return this;
  }

  public InboundOrderCreateRequest addBoxesItem(InboundOrderBoxCreateRequest boxesItem) {
    if (this.boxes == null) {
 ...
 @Size(min=1)
  ...
  public boolean equals(Object o) {
    ...
    InboundOrderCreateRequest inboundOrderCreateRequest = (InboundOrderCreateRequest) o;
    return Objects.equals(this.params, inboundOrderCreateRequest.params) &&
        Objects.equals(this.inboundNo, inboundOrderCreateRequest.inboundNo) &&
        Objects.equals(this.inboundType, inboundOrderCreateRequest.inboundType) &&
        Objects.equals(this.arriveMethod, inboundOrderCreateRequest.arriveMethod) &&
        Objects.equals(this.asnOrderCode, inboundOrderCreateRequest.asnOrderCode) &&
        Objects.equals(this.warehouseCode, inboundOrderCreateRequest.warehouseCode) &&
        Objects.equals(this.transportType, inboundOrderCreateRequest.transportType) &&
        Objects.equals(this.expectArriveTime, inboundOrderCreateRequest.expectArriveTime) &&
        Objects.equals(this.trackingNo, inboundOrderCreateRequest.trackingNo) &&
        Objects.equals(this.carrierCode, inboundOrderCreateRequest.carrierCode) &&
        Objects.equals(this.attachmentUrls, inboundOrderCreateRequest.attachmentUrls) &&
        Objects.equals(this.remark, inboundOrderCreateRequest.remark) &&
        Objects.equals(this.boxes, inboundOrderCreateRequest.boxes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(params, inboundNo, inboundType, arriveMethod, asnOrderCode, warehouseCode, transportType, expectArriveTime, trackingNo, carrierCode, attachmentUrls, remark, boxes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InboundOrderCreateRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("inboundType");
  ...
  * @throws IOException if the JSON Element is invalid with respect to InboundOrderCreateRequest
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InboundOrderCreateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InboundOrderCreateRequest is not found in the empty JSON string", InboundOrderCreateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InboundOrderCreateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InboundOrderCreateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InboundOrderCreateRequest.openapiRequiredFields) {
      ...
      // validate the required field `inboundType`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InboundOrderCreateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InboundOrderCreateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InboundOrderCreateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InboundOrderCreateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<InboundOrderCreateRequest>() {
           @Override
           public void write(JsonWriter out, InboundOrderCreateRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InboundOrderCreateRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of InboundOrderCreateRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InboundOrderCreateRequest
  * @throws IOException if the JSON string is invalid with respect to InboundOrderCreateRequest
  */
  public static InboundOrderCreateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InboundOrderCreateRequest.class);
  }

 /**
  * Convert an instance of InboundOrderCreateRequest to an JSON string
  *
  * @return JSON string
  */
