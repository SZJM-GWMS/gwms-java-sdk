 ...
 * 业务类型枚举
 */
@JsonAdapter(ChargeBizType.Adapter.class)
public enum ChargeBizType {
   ...
   * 库中
   */
  WAREHOUSEINTERNAL("warehouseInternal"),
  ...
  public static ChargeBizType fromValue(String value) {
    for (ChargeBizType b : ChargeBizType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ChargeBizType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ChargeBizType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ChargeBizType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ChargeBizType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ChargeBizType.fromValue(value);
  }
}
