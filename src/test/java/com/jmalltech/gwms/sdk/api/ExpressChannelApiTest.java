...
/**
 * API tests for ExpressChannelApi
 */
@Disabled
public class ExpressChannelApiTest {

    private final ExpressChannelApi api = new ExpressChannelApi();
    ...
    public void callListTest() throws ApiException {
        ApiListResponseBase response = api.callList();
